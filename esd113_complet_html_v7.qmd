...
Avec plus de soixante-quinze pages de développements théoriques approfondis, de démonstrations mathématiques et de mises en œuvre reproductibles en R, ce document constitue un *rapport de référence méthodologique* — et non un simple aide-mémoire. Chaque concept y est présenté avec la rigueur d'un manuel académique : définitions formelles, preuves ou justifications, implémentation en R et interprétation critique des résultats. Un recours significatif aux outils d'intelligence artificielle a permis de résoudre les problématiques complexes de mise en page et de structuration du contenu.
